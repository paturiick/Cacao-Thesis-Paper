...
The programmable nature of the UAV allows the use of the SDK to define autonomous flight paths, enabling systematic data collection across cacao rows. However, the extent of automation depends on the reliability of programmed commands and the environmental conditions encountered during missions. 
